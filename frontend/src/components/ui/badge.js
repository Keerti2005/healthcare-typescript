...
const badgeIntents = {
    ...
    warning: "bg-amber-400/20 text-amber-700 group-hover:bg-amber-400/30 dark:bg-amber-400/10 dark:text-amber-400 dark:group-hover:bg-amber-400/15",
...
const Badge = ({ children, intent, shape, className, ...props }) => {
    return (_jsx("span", { ...props, className: badgeStyles({ intent, shape, className }), children: children }));
};
